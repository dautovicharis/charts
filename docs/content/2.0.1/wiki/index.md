<div style="text-align: center; margin-bottom: 20px;">
  <img src="/content/2.0.1/wiki/assets/logo.png" alt="Charts Library Logo" style="max-width: 500px;">
</div>
...
<div style="text-align: center; margin: 2rem 0;">
  <img src="/content/2.0.1/wiki/assets/demo.gif" alt="Charts Demo" style="max-width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
</div>
