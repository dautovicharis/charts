...
class DefaultPieSampleUseCase : PieSampleUseCase {
    ...
    private val pieCustomLabels = listOf(
        "Public Transport",
        "Fuel",
        "Groceries",
        "Eating out",
    ...
    override fun initialPieSample(title: String, postfix: String): PieSampleData {
    ...
    override fun pieCustomSample(range: IntRange, title: String, postfix: String): PieSampleData {
    ...
    private fun buildPieSample(
        ...
        val segmentKeys = if (labels.isNotEmpty()) {
            labels
        } else {
