...
class DefaultMultiLineSampleUseCase : MultiLineSampleUseCase {
    ...
    private val multiLineItems = listOf(
    ...
    override fun initialMultiLineSample(title: String, prefix: String): MultiLineSampleData {
        val dataSet = multiLineItems.toMultiChartDataSet(
            prefix = prefix,
    ...
    override fun multiLineSample(
        ...
        val newItems = multiLineItems.map { (name, values) ->
