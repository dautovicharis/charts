...
class DefaultRadarSampleUseCase : RadarSampleUseCase {
    private val radarCategories = listOf(
        "Speed",
        "Strength",
        "Agility",
        "Stamina",
    ...
    private val radarInitialItems = listOf(
    ...
    override fun initialRadarSample(title: String): RadarSampleData {
        val basicDataSet = radarBasicValues.toChartDataSet(
            title = title,
            labels = radarCategories
        )
        val customDataSet = radarInitialItems.toMultiChartDataSet(
            title = title,
    ...
    override fun radarBasicDataSet(range: IntRange, title: String): ChartDataSet {
    ...
    override fun radarCustomSample(range: IntRange, title: String): RadarCustomSampleData {
        val newItems = radarInitialItems.map { (name, values) ->
